document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- 設定項目 ---
    const images = [
        'images/works/showtime_asmr.png',       // 作品画像1
        'images/works/amaamaosananazimi.png', // 作品画像2
        'images/works/oshikake_story.png',   // 作品画像3
        'images/works/delivery_spirits_top.png',    // 作品画像4
        'images/works/JewelryHunter_web.png',       // 作品画像5
    ];
    // --- 設定はここまで ---
